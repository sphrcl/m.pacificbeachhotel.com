...
$videobox = array (
	'Slide Configuration' => array (
			array( 'featimg', '' , 'radio'),
			array( 'heading', 'If you would like to add a slide heading, put it here. .. but keep it short" ' , 'textfield'),
			array( 'desc', 'If you would like to add a slide description, put it here" ' , 'textfield'),
			array( 'button1name', 'If you would like to have a button(1) attached to this slide, name it and give your link below' , 'textfield'),
			array( 'button1link', 'Button (1) Link' , 'textfield'),
			array( 'button2name', 'If you would like to have a button(2) attached to this slide, name it and give your link below' , 'textfield'),
			array( 'button2link', 'Button (2) Link' , 'textfield'),
			array( 'button3name', 'If you would like to have a button(3) attached to this slide, name it and give your link below' , 'textfield'),
			array( 'button3link', 'Button (3) Link' , 'textfield'),
		),
